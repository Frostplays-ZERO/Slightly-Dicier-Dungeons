...
var jester_dice_pool = ["Nudge", "Spatula", "Bump", "Cauldron", "Bump"];
var jester_damage_pool = ["Juggling Ball", "Boop", "Shovel", "Lament", "Whip", "Hammer", "Blood Suck"];
...
goodotherstuff = [
  shop([jester_damage_pool.pop(), "Two Handed Sword", "Upgrade"], [2, 3, 2]),
  copyshop()
];
...
goodotherstuff = [
  shop([jester_dice_pool.pop(), jester_damage_pool.pop(), "Upgrade"])
];
...
items = [];
gooditems = [];
otherstuff = [health(), health(), shop(["Delete", "Upgrade", "Delete"], shuffle([2,3,4]))];
goodotherstuff = [copyshop()];
